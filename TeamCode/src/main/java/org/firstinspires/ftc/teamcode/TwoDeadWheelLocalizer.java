...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2249.5897870732274; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -442.27301223488223; // x position of the perpendicular encoder (in tick units)
    }
